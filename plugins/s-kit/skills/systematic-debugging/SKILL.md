...
1. **Create Failing Test Case**
   ...
   - Use the `s-kit:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **s-kit:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **s-kit:verification-before-completion** - Verify fix worked before claiming success
